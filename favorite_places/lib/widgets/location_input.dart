...
final apiKey = dotenv.env['GOOGLE_MAPS_API_KEY'] ?? 'default_api_key';

class LocationInput extends StatefulWidget {
  const LocationInput({
    super.key,
    required this.onSelectLocaiton,
  });

  final void Function(PlaceLocation locaiton) onSelectLocaiton;
...
class _LocationInputState extends State<LocationInput> {
  ...
  void _getCurrentLocation() async {
    ...
    widget.onSelectLocaiton(_pickedLocation!);
  }
